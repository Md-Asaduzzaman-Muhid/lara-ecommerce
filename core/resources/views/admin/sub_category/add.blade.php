            ...
            <div class="card">
                <form action="{{ route('admin.sub_category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="payment-method-header">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview" style="background-image: url('{{getImage(imagePath()['product']['image']['path'],imagePath()['product']['image']['size'])}}')"></div>
                                    </div>
                                    ...
                                    <div class="row mt-4 mb-none-15">
                                        <div class="col-12 mb-15">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="@lang('Method Name')" name="title" value="{{ old('name') }}"/>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-15">
                                            <div class="input-group">
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="8" class="form-control border-radius-5 nicEdit" name="description">{{ old('instruction') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn--primary btn-block">@lang('Save Category')</button>
                    </div>
                </form>
            </div>
        </div>

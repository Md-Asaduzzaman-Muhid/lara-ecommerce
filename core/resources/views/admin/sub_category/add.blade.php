                                    ...
                                    <div class="row mt-4 mb-none-15">
                                         <div class="col-12 mb-15">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="@lang('Method Name')" name="title" value="{{ old('name') }}" required/>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-15">
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="8" class="form-control border-radius-5 nicEdit" name="description">{{ old('description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
